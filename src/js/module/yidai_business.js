elife.controller('YidaiBusinessCtrl', ['$scope', '$routeParams', 'SharedState', '$http', '$cookieStore', 'API', '$rootScope', function ($scope, $routeParams, SharedState, $http, $cookieStore, API, $rootScope) {
