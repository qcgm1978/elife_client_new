elife.controller('JifenBusinessCtrl', ['$scope', '$routeParams', 'SharedState', '$http', '$cookieStore', 'API', '$rootScope',function ($scope, $routeParams, SharedState, $http, $cookieStore, API,$rootScope) {
...
//排序
    $scope.filterBySort = function (rType, rName) {
