elife.controller('GuessULikeListCtrl', ['$scope', '$routeParams', 'SharedState', '$http', '$cookieStore', 'API', '$rootScope', function ($scope, $routeParams, SharedState, $http, $cookieStore, API, $rootScope) {
...
//    }
        ...
        //获取猜你喜欢列表
        API.getGuessLikeList(para).then(function (data) {
            console.log("搜索结果:");
            console.log(data);
            $scope.list = data;
            ...
            if ((!$scope.list || $scope.list.length === 0)) {
                ...
                for (var i = 0; i < $scope.list.length; i++) {
                    ...
                    listItem.bottomContent = listItem.bottomContent.substring(0, listItem.bottomContent.length - 1);
                    listItem.showdistance = listItem.distance + listItem.unit || '0.0m';
                }
