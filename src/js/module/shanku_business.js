elife.controller('ShankuBusinessCtrl', ['$scope', '$routeParams', 'SharedState', '$http', '$cookieStore', 'API', '$rootScope', function ($scope, $routeParams, SharedState, $http, $cookieStore, API, $rootScope) {
...
//排序
    ...
    $scope.e_row = 0;
    $scope.page_size = 9;
    $scope.toast('商户支持"quickpass"银联卡快速支付');
    $scope.getList = function () {
        ...
        //});
        //return;
        API.getShanKuBySearch(para).then(function (data) {
            console.log("搜索结果:");
            console.log(data);
