...
elife.controller('TradeListCtrl', ['$scope', '$http', '$cookieStore', '$rootScope','SharedState', function ($scope, $http, $cookieStore, $rootScope, SharedState) {
    ...
    var listUrl = "http://localhost/OFSTCUST/listTrade/receive.action";//var listUrl = $rootScope.baseUrl + "/OFSTCUST/listTrade/receive.action";
...
elife.controller('TradeDetailCtrl', ['$scope', '$http', '$routeParams', '$cookieStore', '$rootScope', 'API', function ($scope, $http, $routeParams, $cookieStore, $rootScope, API) {
    ...
    var detailUrl = "http://localhost/OFSTCUST/detailTrade/receive.action";//var detailUrl = $rootScope.baseUrl + "/OFSTCUST/detailTrade/receive.action";
	...
	obs._on('positionCallback', function () {
        ...
        var storeUrl = "http://localhost/OFSTCUST/storeInfo/receive.action";//var storeUrl = $rootScope.baseUrl + "/OFSTCUST/storeInfo/receive.action";
...
elife.controller('TradeReturnCtrl', ['$scope', '$http', '$routeParams', '$rootScope', '$cookieStore', function ($scope, $http, $routeParams, $rootScope, $cookieStore) {
	...
	var tokenid = $cookieStore.get('t_k');
    var channelid = ICBCUtil.getIMChannel();
    var custUrl = "http://localhost/OFSTCUST/custInfo/receive.action";//var custUrl = $rootScope.baseUrl + "/OFSTCUST/custInfo/receive.action";
    $http.post(custUrl,
        {
            "tokenid": tokenid,
            "channelid": channelid
    ...
    $scope.returnSubmit = function () {
		...
		if(document.getElementById("rejectAmt").value != "" &&
			...
			document.getElementById("contactTele").value != ""){
			 var rejectUrl = "http://localhost/OFSTCUST/rejectTrade/receive.action";//var rejectUrl = $rootScope.baseUrl + "/OFSTCUST/rejectTrade/receive.action";
	        $http.post(rejectUrl,
